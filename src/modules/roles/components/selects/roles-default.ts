import { MessageActionRow, MessageEmbed, MessageSelectMenu, SelectMenuInteraction, Message, MessageButton } from "discord.js";
...
exports.run = async (Client: SuperChan, i: SelectMenuInteraction) => {
    ...
    try {
        ...
        (i.message as Message).edit({ content: `${emojis.timer} \*\*Última interação:\*\* <t:${Number((Date.now()) / 1000).toFixed()}:R>`, components: [row, row1] });
